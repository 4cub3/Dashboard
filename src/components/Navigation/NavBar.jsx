...
const NavBar = () => {
  ...
  return (
    ...
    <nav className={`bg-primary absolute h-screen z-[900] smd:relative flex flex-col flex-3 overflow-hidden transition-all  duration-300 ${navExpand ? 'p-12' : 'w-0  p-0 smd:w-auto'}`}>
        {/* Nav button*/}
