...
const MainNav = () => {
  ...
  return (
    <nav className="flex smm:items-center space-y-4 smm:space-y-0 flex-col smm:flex-row justify-between sm:px-[4.4rem] px-9 py-6 sticky sm:top-60 bg-white smm:top-44 smd:relative smd:top-0 z-10">
