...
const Header = () => {
  return (
    <header className='flex flex-col space-y-12 items-start smm:space-y-0 smm:flex-row smm:items-center justify-between sticky top-0 lg:relative bg-white dark:bg-gradient-to-r dark:from-slate-950 dark:to-slate-900 transition-colors duration-300 dark:text-white z-50 px-9 py-12 sm:px-[4.4rem] sm:py-[3rem] '>
        <article>
