...
const Header = () => {
  return (
    <section className='sticky top-0 z-50 w-full '>  
      <header className='flex flex-col space-y-12 items-start smm:space-y-0 smm:flex-row smm:items-center justify-between w-full  transition-colors duration-300 dark:text-white  px-9 py-4 sm:px-[4.4rem] sm:py-[3rem] backdrop-blur-lg'>
        <article>
